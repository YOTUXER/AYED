...
class pair_t {
 public:
  ...
  // E/S
  std::istream& read(std::istream& is = std::cin); //metodo para escribir la pareja
  std::ostream& write(std::ostream& os = std::cout) const; //metodo para leer la pareja
