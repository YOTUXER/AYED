...
int main(int argc, char* argv[]) {
  ...
  //Modificación 
  cout << "MODIFICACION sp1 "; 
  sp1.Mostrar_solo_elementos_pares();
  cout << endl;
  cout << "MODIFICACION sp2 "; 
  sp2.Mostrar_solo_elementos_pares();
  cout << endl;
  cout << "MODIFICACION sp3 "; 
  sp3.Mostrar_solo_elementos_pares();
  cout << endl;
